...
Menu_Figures    = Enum('Menu_Figures', 'Square, Rectangle, Circle, Triangle , Trapeze' )
...
elif (choose == Menu_Figures.Circle.value): # Circle
    r       = float(input("Enter the radius of circle: "))
    print("The area of circle is equal to:", AreaFiguresCAP25.area_of_circle(r))
elif (choose == Menu_Figures.Triangle.value): #Triangle
...
elif (choose == Menu_Figures.Trapeze.value): #Trapeze
